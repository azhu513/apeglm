...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type intercept(interceptSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type cnst(cnstSEXP);
    rcpp_result_gen = Rcpp::wrap(nbinomGLM(x, Y, size, weights, offset, sigma2, S2, no_shrink, shrink, intercept, cnst));
